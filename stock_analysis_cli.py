...
\n2.Manual \nChoice: "))
        if sub_task_para == 1:
            ...
            print("In Manual mode whereever you see 'default' then presing enter key will take default value")
            sub_task_para_duration = int(input("Input desired duration (default: 90): ") or 90)
            sub_task_para_export = (input('Enter path to save result (eg: ./some_folder) (default: .  (to save in current working directory): ') or '.')
            sub_task_para_verbosity = int(input('Input Verbosity [level 0: Minimal, 1: Detail (default: 1)]: ') or 1)
...
\n2.Manual \nChoice: "))
        if sub_task_para == 1:
            ...
            print("In Manual mode whereever you see 'default' then presing enter key will take default value: ")
            sub_task_para_emacandidate1 = int(input("Input desired first EMA candidate (default: 50): ") or 50)
            sub_task_para_emacandidate2 = int(input("Input desired second EMA candidate (default: 200): ") or 200)
            sub_task_para_export = (input('Enter path to save result (eg: ./some_folder) (default: .  (to save in current working directory): ') or '.')
            sub_task_para_verbosity = int(input('Input Verbosity [level 0: Minimal, 1: Detail (default: 1)]: ') or 1)
